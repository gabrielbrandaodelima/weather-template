...
public class YahooWeatherObject extends RealmObject {
    ...
    public YahooWeatherObject(String fechahoraConsulta, String condDia, float tActual, float tMax, float tMin, float presion, int humedad, float vViento) {
